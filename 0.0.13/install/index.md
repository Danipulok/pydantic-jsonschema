...
See [Formats](https://danipulok.github.io/pydantic-jsonschema/0.0.13/formats/index.md) for supported formats and usage examples.
...
For local development, use the [contributing guide](https://danipulok.github.io/pydantic-jsonschema/0.0.13/contributing/index.md) instead. It is the source of truth for development dependencies, `just` recipes, documentation checks, and PR workflow.

## Next Steps

- [Schema](https://danipulok.github.io/pydantic-jsonschema/0.0.13/schema/index.md) - Schema models, fields, and serialization
- [Converters](https://danipulok.github.io/pydantic-jsonschema/0.0.13/converters/index.md) - Create Pydantic models from JSON Schema
