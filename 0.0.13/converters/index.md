...
| `format` with validators                     | configured format validation                | see [Formats](https://danipulok.github.io/pydantic-jsonschema/0.0.13/formats/index.md) |
| `title`, `model_name`, `default_model_name`  | generated class name                        | `User`, `CustomUser`, `Model`                                                          |

## Unknown Keywords

All JSON Schema 2020-12 validation and applicator keywords are enforced on conversion. Unknown or custom keywords are still parsed and preserved on the `Schema` model (`extra="allow"`) but do not affect the generated model.
...
- `format` is metadata unless a matching entry is passed in `formats`. Built-in aliases cover all 19 spec-defined formats, some with minor differences from the spec — see [Formats](https://danipulok.github.io/pydantic-jsonschema/0.0.13/formats/index.md).
...
- [Formats](https://danipulok.github.io/pydantic-jsonschema/0.0.13/formats/index.md) - Add custom validation for special formats
- [Examples](https://danipulok.github.io/pydantic-jsonschema/0.0.13/examples/index.md) - See real-world applications
