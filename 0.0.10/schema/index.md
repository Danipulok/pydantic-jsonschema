...
The `Schema` and `Reference` classes are Pydantic models that represent JSON Schema objects in Python. They are used as the input to the [converter](https://danipulok.github.io/pydantic-jsonschema/0.0.10/converters/index.md).
...
- [Converters](https://danipulok.github.io/pydantic-jsonschema/0.0.10/converters/index.md) - Convert schemas to Pydantic models
- [Format Validators](https://danipulok.github.io/pydantic-jsonschema/0.0.10/formats/index.md) - Add validation for `format` values
- [API Reference](https://danipulok.github.io/pydantic-jsonschema/0.0.10/api/types/index.md) - Full API docs for schema types
