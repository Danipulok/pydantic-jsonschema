...
JSON Schema `format` values describe semantic constraints such as email addresses, UUIDs, URIs, or domain-specific identifiers. Pydantic JSON Schema only enforces those constraints when you pass a matching entry in `format_validators`.
...
See [Installation](https://danipulok.github.io/pydantic-jsonschema/0.0.10/install/#third-party-validator-libraries) for the install commands.
...
The `pydantic_jsonschema.formats` module exports aliases that can be passed to `format_validators`.
...
If you want to use third-party or custom format validators, you can pass them via `format_validators`. Here's an example involving `pydantic-extra-types` package.
...
- [Installation](https://danipulok.github.io/pydantic-jsonschema/0.0.10/install/index.md) - Install optional format validator dependencies
- [Converters](https://danipulok.github.io/pydantic-jsonschema/0.0.10/converters/index.md) - Learn how schema conversion works
- [Examples](https://danipulok.github.io/pydantic-jsonschema/0.0.10/examples/index.md) - Run complete examples
