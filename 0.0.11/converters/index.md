...
| `format` with validators                     | configured format validation                | see [Format Validators](https://danipulok.github.io/pydantic-jsonschema/0.0.11/formats/index.md) |
...
- `format` is metadata unless a matching entry is passed in `format_validators` — see [Format Validators](https://danipulok.github.io/pydantic-jsonschema/0.0.11/formats/index.md). Built-in aliases cover all 19 spec-defined formats; `idn-*` formats use the stdlib IDNA 2003 codec and `regex` uses the Python `re` dialect (see the differences from the specification in [Format Validators](https://danipulok.github.io/pydantic-jsonschema/0.0.11/formats/index.md)).
...
- [Format Validators](https://danipulok.github.io/pydantic-jsonschema/0.0.11/formats/index.md) - Add custom validation for special formats
- [Examples](https://danipulok.github.io/pydantic-jsonschema/0.0.11/examples/index.md) - See real-world applications
