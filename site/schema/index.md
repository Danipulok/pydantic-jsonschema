...
The `Schema` and `Reference` classes are Pydantic models that represent JSON Schema objects in Python. They are used as the input to the [converter](https://danipulok.github.io/pydantic-jsonschema/0.0.12/converters/index.md).
...
`Schema` fields map directly to JSON Schema keywords. Other or custom keywords are preserved via `extra="allow"`. Some declared keywords round-trip through parsing and serialization but are not yet consumed by the converter.
...
- [Converters](https://danipulok.github.io/pydantic-jsonschema/0.0.12/converters/index.md) - Convert schemas to Pydantic models
- [Formats](https://danipulok.github.io/pydantic-jsonschema/0.0.12/formats/index.md) - Add validation for `format` values
- [API Reference](https://danipulok.github.io/pydantic-jsonschema/0.0.12/api/types/index.md) - Full API docs for schema types
