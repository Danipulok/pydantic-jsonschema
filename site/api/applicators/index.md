...
For the concepts behind these classes — what an applicator is and why it is named that — see the [Applicators guide](https://danipulok.github.io/pydantic-jsonschema/0.0.12/applicators/index.md).
