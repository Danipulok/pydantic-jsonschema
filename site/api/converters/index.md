...
| `formats`            | \`dict[FormatName, FormatValidatorType] | None\`                                                   | Validators keyed by JSON Schema format value.  |
...
| `formats`    | \`dict[FormatName, FormatValidatorType] | None\`             | Custom format validators (callables, types, or Annotated). |
| `model_name` | \`str                                   | None\`             | Name for the generated model.                              |
